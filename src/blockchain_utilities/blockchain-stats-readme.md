...
See also the utility's help option. `lethean-blockchain-stats --help`
...
- `lethean-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `lethean-blockchain-stats | save-to-database.sh`
